...
const DEFAULT_IMAGES: DomeGalleryImage[] = [
  { src: "/gallery-photos/photo_1_2026-04-22_20-10-03.jpg", alt: "Detail 1" },
  { src: "/gallery-photos/photo_2_2026-04-22_20-10-03.jpg", alt: "Detail 2" },
  { src: "/gallery-photos/photo_3_2026-04-22_20-10-03.jpg", alt: "Detail 3" },
  { src: "/gallery-photos/photo_4_2026-04-22_20-10-03.jpg", alt: "Detail 4" },
  { src: "/gallery-photos/photo_5_2026-04-22_20-10-03.jpg", alt: "Detail 5" },
  { src: "/gallery-photos/photo_6_2026-04-22_20-10-03.jpg", alt: "Detail 6" },
];
...
function buildItems(pool: (DomeGalleryImage | string)[], seg: number) {
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el: HTMLDivElement) => {
      ...
      overlay.style.transition = `transform ${enlargeTransitionMs}ms cubic-bezier(0.22, 1, 0.36, 1), opacity ${enlargeTransitionMs}ms cubic-bezier(0.22, 1, 0.36, 1)`;
  ...
  // --- Native pointer-event drag / tap (replaces @use-gesture/react) ---
  useEffect(() => {
    ...
    const onPointerDown = (e: PointerEvent) => {
      ...
      try {
        ...
        // setPointerCapture can fail if the element is already captured
      }
    };
  ...
  }, [applyTransform, startInertia, dragSensitivity, maxVerticalRotationDeg, stopInertia, openItemFromElement]);
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      animatingOverlay.style.cssText = `position:absolute;left:${overlayRelativeToRoot.left}px;top:${overlayRelativeToRoot.top}px;width:${overlayRelativeToRoot.width}px;height:${overlayRelativeToRoot.height}px;z-index:9999;border-radius: var(--enlarge-radius, 32px);overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.55),0 0 0 1px rgba(255,255,255,.04);transition:all ${enlargeTransitionMs}ms cubic-bezier(0.22, 1, 0.36, 1);pointer-events:none;margin:0;transform:none;`;
