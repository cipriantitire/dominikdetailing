    ...
    <div className="min-h-screen bg-[#09090d] text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-20 md:px-6 md:py-24">
        ...
        <div className="mt-8 space-y-6 text-[13px] leading-relaxed text-[#686878]">
          ...
          <h2 className="text-[16px] font-semibold text-white">Booking Requests</h2>
          <p>
          ...
          <h2 className="text-[16px] font-semibold text-white">Pricing</h2>
          <p>
          ...
          <h2 className="text-[16px] font-semibold text-white">Cancellation</h2>
          <p>
            We request at least 24 hours&apos; notice for cancellations or rescheduling. Late cancellations may incur a fee.
          </p>

          <h2 className="text-[16px] font-semibold text-white">Satisfaction Guarantee</h2>
          <p>
          ...
          <h2 className="text-[16px] font-semibold text-white">Liability</h2>
          <p>
